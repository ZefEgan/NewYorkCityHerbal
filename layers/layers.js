...
var format_FlorareferencedbyDioscorides_6 = new ol.format.GeoJSON();
var features_FlorareferencedbyDioscorides_6 = format_FlorareferencedbyDioscorides_6.readFeatures(json_FlorareferencedbyDioscorides_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_FlorareferencedbyDioscorides_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_FlorareferencedbyDioscorides_6.addFeatures(features_FlorareferencedbyDioscorides_6);
var lyr_FlorareferencedbyDioscorides_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_FlorareferencedbyDioscorides_6, 
                style: style_FlorareferencedbyDioscorides_6,
                popuplayertitle: 'Flora referenced by Dioscorides',
                interactive: true,
                title: '<img src="styles/legend/FlorareferencedbyDioscorides_6.png" /> Flora referenced by Dioscorides'
            });

lyr_Boroughs_0.setVisible(true);lyr_Cemeteries_1.setVisible(true);lyr_ProspectPark_2.setVisible(true);lyr_Parks_3.setVisible(true);lyr_MajorRoads_4.setVisible(true);lyr_Waterfeature_5.setVisible(true);lyr_FlorareferencedbyDioscorides_6.setVisible(true);
var layersList = [lyr_Boroughs_0,lyr_Cemeteries_1,lyr_ProspectPark_2,lyr_Parks_3,lyr_MajorRoads_4,lyr_Waterfeature_5,lyr_FlorareferencedbyDioscorides_6];
...
lyr_FlorareferencedbyDioscorides_6.set('fieldAliases', {'observed_o': 'observed_o', 'url': 'url', 'descriptio': 'descriptio', 'latitude': 'latitude', 'longitude': 'longitude', 'scientific': 'scientific', 'common_nam': 'common_nam', 'BoroName': 'BoroName', 'propertyna': 'propertyna', 'botan_illu': 'botan_illu', 'layer': 'layer', });
...
lyr_FlorareferencedbyDioscorides_6.set('fieldImages', {'observed_o': 'DateTime', 'url': 'TextEdit', 'descriptio': 'TextEdit', 'latitude': 'TextEdit', 'longitude': 'TextEdit', 'scientific': 'TextEdit', 'common_nam': 'TextEdit', 'BoroName': 'TextEdit', 'propertyna': 'TextEdit', 'botan_illu': 'TextEdit', 'layer': 'TextEdit', });
...
lyr_FlorareferencedbyDioscorides_6.set('fieldLabels', {'observed_o': 'hidden field', 'url': 'no label', 'descriptio': 'no label', 'latitude': 'hidden field', 'longitude': 'hidden field', 'scientific': 'no label', 'common_nam': 'no label', 'BoroName': 'hidden field', 'propertyna': 'hidden field', 'botan_illu': 'no label', 'layer': 'hidden field', });
lyr_FlorareferencedbyDioscorides_6.on('precompose', function(evt) {
